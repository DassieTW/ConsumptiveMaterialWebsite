        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.type == 'add') {
                    ...
                    rowtransit.innerHTML = "<span id=" + "transit" + index + ">" + data.transit + "</span>";

                    let rowstock = document.createElement('td');
                    rowstock.innerHTML = "<span id=" + "stock" + index + ">" + data.stock + "</span>";
                    ...
                    rowpositions.innerHTML = "<span id=" + "positions" + index + ">" + data.positions + "</span>";

                    let rowlocation = document.createElement("td");
                    rowlocation.innerHTML = '<select id="newposition' + index + '"' + 'class = "form-select form-select-lg"' + 'style="width: 150px"' + "required>";
