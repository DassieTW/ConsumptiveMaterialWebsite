    ...
    $('#uploadpeople').on('submit', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var mess = Lang.get('loginPageLang.total') + ' : ' + row.length + Lang.get('loginPageLang.record') +
                    Lang.get('loginPageLang.data') + ' ， ' + Lang.get('loginPageLang.success') + Lang.get('loginPageLang.upload1') +
                    ' : ' + data.record + ' ' + Lang.get('loginPageLang.pinf');
