  ...
  $("#backlist").on("submit", function (e) {
    ...
    for (let i = 0; i < count; i++) {
      if ($("#client" + i).text() !== null && $("#client" + i).text() !== "") {
        ...
        if ($("#status" + i).val() === null) {
          $("#status" + i).addClass("is-invalid");
          $("#status" + i).focus();
          notyf.open({
            type: "warning",
            message:
              ...
              (i + 1) +
              " " +
              Lang.get("outboundpageLang.enterstatus"),
            duration: 3000, //miliseconds, use 0 for infinite duration
            ripple: true,
            dismissible: true,
            position: {
    ...
    if (check1 === -1) {
      notyf.open({
        type: "warning",
        message: Lang.get("outboundpageLang.noreceivepeople"),
        duration: 3000, //miliseconds, use 0 for infinite duration
        ripple: true,
        dismissible: true,
        position: {
    ...
    if (check2 === -1) {
      notyf.open({
        type: "warning",
        message: Lang.get("outboundpageLang.nobackpeople"),
        duration: 3000, //miliseconds, use 0 for infinite duration
        ripple: true,
        dismissible: true,
        position: {
