  ...
  $("#stand").on("submit", function (e) {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        rowmpq.innerHTML =
          "<span id=" + "mpq" + index + ">" + data.mpq + "</span>";
        ...
        rownextdayneed.innerHTML =
          '<input id="nextdayneed' +
          index +
          '"' +
          'type = "number"' +
          'class = "form-control form-control-lg"' +
        ...
        $("input").change(function () {
          for (let i = 0; i < sessionStorage.getItem("standcount"); i++) {
            ...
            var lt = $("#lt" + i).text();
            var now =
              (nowpeople * nowclass * nowline * nowuse * nowchange) / mpq;
            var next =
      ...
      success: function (data) {
        ...
        if (sessionStorage.getItem("standcount") === null) {
          ...
          var length =
            ...
            parseInt(sessionStorage.getItem("standcount"));
        ...
        for (let i = 0; i < alldatas.length; i++) {
          ...
          let rowmpq = document.createElement("td");
          rowmpq.innerHTML =
            "<span id=" + "mpq" + j + ">" + alldatas[i].MPQ + "</span>";
          ...
          $("input").change(function () {
            for (let i = 0; i < sessionStorage.getItem("standcount"); i++) {
              ...
              var now =
                (nowpeople * nowclass * nowline * nowuse * nowchange) / mpq;
              var next =
                (nextpeople * nextclass * nextline * nextuse * nextchange) /
                mpq;
              var safe = next * lt;
              now = now.toFixed(7);
              next = next.toFixed(7);
