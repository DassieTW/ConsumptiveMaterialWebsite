    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        rowamount.innerHTML =
          ...
          'value = "1"' +
          "placeholder=" +
          Lang.get("monthlyPRpageLang.enteramount") +
          " required>";
        ...
        rowsxb.innerHTML =
          ...
          " >" +
          '<div class="invalid-feedback" id="sxberror' +
          count +
          '"' +
        ...
        rowsay.innerHTML =
          ...
          'class = "form-control"' +
          "placeholder=" +
          Lang.get("monthlyPRpageLang.enterdesc") +
          ">" +
          '<div class="invalid-feedback" id="sayerror' +
          count +
          '"' +
          'style="display:none; color:red;"' +
          ">" +
        ...
        rowmonth.innerHTML =
          "<span id=" + "month" + count + ">" + data.month + "</span>";
    ...
    for (let i = 0; i < count; i++) {
      if ($("#client" + i).text() !== null && $("#client" + i).text() !== "") {
        ...
        if ($("#sxb" + i).val() !== "") {
          ...
          $("#sxb" + i).addClass("is-invalid");
          document.getElementById("sxberror" + i).style.display = "block";
          document.getElementById("sxb" + i).focus();
          return false;
        }
    ...
    for (let i = 0; i < count; i++) {
      if (month[i] === "是") {
        if (say[i] === "") {
          ...
          $("#errorrow")
            .empty()
            .append(Lang.get("monthlyPRpageLang.row") + " " + row);
          document.getElementById("error").style.display = "block";
          $("#say" + i).addClass("is-invalid");
          return false;
        } else if (reason[i] === null) {
          let row = i + 1;
          $("#errorrow")
            .empty()
            .append(Lang.get("monthlyPRpageLang.row") + " " + row);
          document.getElementById("error").style.display = "block";
          $("#reason" + i).addClass("is-invalid");
          return false;
        }
      }
    }
