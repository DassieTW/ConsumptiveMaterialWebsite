...
$(function () {
  ...
  $("#picklist").on("submit", function (e) {
    ...
    if (parseInt(realout) !== parseInt(realpick)) {
      var mess =
        Lang.get("bupagelang.realpickamount") + Lang.get("bupagelang.notequal");
    ...
    if (!sure) {
      ...
      var mess =
        ...
        realout +
        " " +
        Lang.get("bupagelang.realpickamount") +
        " : " +
        realpick +
        " " +
        ...
        error: function (err) {
          ...
          //inventory error
            ...
            var mess =
              ...
              list +
              " " +
              Lang.get("bupagelang.outfactory") +
              " : " +
              outfactory +
              " " +
              Lang.get("bupagelang.inventoryerr");
            alert(mess);
            return false;
          }
        },
