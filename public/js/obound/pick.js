...
$(document).ready(function () {
    $('#pick').on('submit', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                sessionStorage.setItem('opickcount', index + 1);
    ...
    $('#pickadd').on('submit', function (e) {
        ...
        console.log(sessionStorage.getItem('opickcount'));
        var data = [];
        var client = [];
        var machine = [];
        var production = [];
        ...
        for (let i = 0; i < sessionStorage.getItem('opickcount'); i++) {
        ...
        $.ajax({
            ...
            success: function (data) {
                var mess = Lang.get('oboundpageLang.total') + ':' + data.record + Lang.get('oboundpageLang.record') + Lang.get('oboundpageLang.add') + Lang.get('oboundpageLang.success') + ' ， ' +
                    Lang.get('oboundpageLang.picklistnum') + ' : ' + data.message;
                alert(mess);
