...
function addBtn(index) {
    ...
    rowlocation.innerHTML = '<select id="bound' + count + '"' + 'class = "form-select form-select-lg"' + 'style="width: 150px"' + "required>";
    ...
    $("#picklist").on("submit", function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                var mess =
                    Lang.get("oboundpageLang.total") + " : " + data.record + ' ' +
                    Lang.get("oboundpageLang.record") + ' ' + Lang.get("oboundpageLang.outpickok") + " : " + data.list;
                alert(mess);
            ...
            error: function (err) {
                ...
                if (err.status == 421) {
                    ...
                    $("#lessstock #amount").html(
                        Lang.get("oboundpageLang.realpickamount") + " : " + amount[err.responseJSON.row]
                    );
