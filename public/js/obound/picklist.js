    ...
    $.ajax({
      ...
      error: function (err) {
        ...
        if (err.status == 421) {
          ...
          $("#lessstock #row").html(
            Lang.get("oboundpageLang.row") + " : " + (err.responseJSON.row + 1)
          );
          $("#lessstock #bound").html(
            Lang.get("oboundpageLang.nowbound") +
              " : " +
              err.responseJSON.bound +
              "<br>" +
              Lang.get("oboundpageLang.stockless")
          );
          $("#lessstock #nowstock").html(
            Lang.get("oboundpageLang.nowstock") +
              " : " +
              err.responseJSON.nowstock
          );
          $("#lessstock #amount").html(
            Lang.get("oboundpageLang.realpickamount") +
              " : " +
