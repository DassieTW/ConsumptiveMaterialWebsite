...
import useInventorySearch from "../../composables/InventorySearch.ts";
export default defineComponent({
    name: "App",
    components: { TableLite },
    setup() {
        const { mats, getInventory } = useInventorySearch(); // axios get the mats data

        onBeforeMount(getInventory);
