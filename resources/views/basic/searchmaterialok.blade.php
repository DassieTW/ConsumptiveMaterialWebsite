                ...
                <div class="d-flex w-100 h-100">
                    <div class="mb-3">
                        ...
                        <form action="{{ route('basic.materialchangeordel') }}" method="POST">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id = "test">
                                    <tr>
                                        ...
                                        <th><input type = "hidden" id = "title3" name = "title3" value = "A級資材">{!! __('basicInfoLang.gradea') !!}</th>
                                        <th><input type = "hidden" id = "title4" name = "title4" value = "月請購">{!! __('basicInfoLang.month') !!}</th>
                                        <th><input type = "hidden" id = "title5" name = "title5" value = "發料部門">{!! __('basicInfoLang.senddep') !!}</th>
                                        <th><input type = "hidden" id = "title6" name = "title6" value = "耗材歸屬">{!! __('basicInfoLang.belong') !!}</th>
                                        <th><input type = "hidden" id = "title7" name = "title7" value = "單價">{!! __('basicInfoLang.price') !!}</th>
                                        <th><input type = "hidden" id = "title8" name = "title8" value = "幣別">{!! __('basicInfoLang.money') !!}</th>
                                        <th><input type = "hidden" id = "title9" name = "title9" value = "單位">{!! __('basicInfoLang.unit') !!}</th>
                                        <th><input type = "hidden" id = "title10" name = "title10" value = "MPQ">{!! __('basicInfoLang.mpq') !!}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$data->規格}}</td>
                                            <td>
                                                <select class="form-control form-control-lg " id = "gradea{{$loop->index}}" name="gradea{{$loop->index}}">
                                            ...
                                            <td>
                                                <select class="form-control form-control-lg " id = "month{{$loop->index}}" name="month{{$loop->index}}">
                                            ...
                                            <td>
                                                <select class="form-control form-control-lg " id = "send{{$loop->index}}" name="send{{$loop->index}}">
                                            ...
                                            <td>
                                                <select class="form-control form-control-lg " id = "belong{{$loop->index}}" name="belong{{$loop->index}}">
                                                <option>{{$data->耗材歸屬}}</option>
                                                <option>單耗</option>
                                                <option>站位</option>
                                                </select>
                                            </td>
                                            <td><input style="width:100px" type = "number" id = "price{{$loop->index}}" name = "price{{$loop->index}}" value = "{{$data->單價}}"></td>
                                            <td><input style="width:100px" type = "text" id = "money{{$loop->index}}" name = "money{{$loop->index}}" value = "{{$data->幣別}}"></td>
                                            <td><input style="width:100px" type = "text" id = "unit{{$loop->index}}" name = "unit{{$loop->index}}" value = "{{$data->單位}}"></td>
                                            <td><input style="width:100px" type = "number" id = "mpq{{$loop->index}}" name = "mpq{{$loop->index}}" value = "{{$data->MPQ}}"></td>
                                            <td><input style="width:100px" type = "number" id = "moq{{$loop->index}}" name = "moq{{$loop->index}}" value = "{{$data->MOQ}}"></td>
                                            <td><input style="width:100px" type = "number" id = "lt{{$loop->index}}" name = "lt{{$loop->index}}" value = "{{$data->LT}}"></td>
                                            <td><input style="width:100px" type = "number" id = "safe{{$loop->index}}" name = "safe{{$loop->index}}" value = "{{$data->安全庫存}}"></td>
                                        </tr>
                            ...
                            <input type = "submit" id = "download" name = "download" class="btn btn-lg btn-primary" value="{!! __('basicInfoLang.download') !!}">
                        </form>
                    </div>
                </div>
                <button class="btn btn-lg btn-primary" onclick="location.href='{{route('basic.material')}}'">{!! __('basicInfoLang.return') !!}</button>
            </div>
        </div>
</html>
@endsection
