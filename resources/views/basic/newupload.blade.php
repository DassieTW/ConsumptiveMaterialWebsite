...
@section('js')
    <script src="{{ asset('js/basic/uploadnew.js?v=') . env('APP_VERSION') }}"></script>
@endsection
                            ...
                            <table class="table">
                                <tr>
                                    ...
                                    <th><input type="hidden" id="title1" name="title1"
                                            value="品名">{!! __('basicInfoLang.pName') !!}
                                    </th>
                                    <th><input type="hidden" id="title2" name="title2"
                                            value="規格">{!! __('basicInfoLang.format') !!}
                                    </th>
                                    <th><input type="hidden" id="title2" name="title3"
                                            value="單價">{!! __('basicInfoLang.price') !!}
                                    </th>
                                    <th><input type="hidden" id="title2" name="title4"
                                            value="幣別">{!! __('basicInfoLang.money') !!}
                                    </th>
                                    <th><input type="hidden" id="title2" name="title5"
                                            value="單位">{!! __('basicInfoLang.unit') !!}
                                    </th>
                                    <th><input type="hidden" id="title2" name="title6"
                                            value="MPQ">{!! __('basicInfoLang.mpq') !!}
                                    </th>
                                    <th><input type="hidden" id="title2" name="title7"
                                            value="MOQ">{!! __('basicInfoLang.moq') !!}
                                    </th>
                                    <th><input type="hidden" id="title2" name="title8"
                                            value="LT">{!! __('basicInfoLang.lt') !!}
                                    </th>
                                    <th><input type="hidden" id="title2" name="title9"
                                            value="月請購">{!! __('basicInfoLang.month') !!}
                                    </th>
                                    ...
                                    <tr id="row{{ $loop->index }}">
                                        ...
                                        <td>
                                            <select style="width:100px" class="form-select form-select-lg "
                                                ...
                                                <option style="display: none" selected value="{{ $row[4] }}">
                                                    {{ $row[4] }}</option>
                                                <option>RMB</option>
                                                <option>USD</option>
                                                <option>TWD</option>
                                        ...
                                        <td><input class="form-control form-control-lg" style="width:100px"
                                                type="text" id="data5a{{ $loop->index }}"
                                                name="data5a{{ $loop->index }}" value="{{ $row[5] }}" required>
                                        </td>
                                        <td><input class="form-control form-control-lg" style="width:100px"
                                                type="number" id="data6a{{ $loop->index }}"
                                                name="data6a{{ $loop->index }}" value="{{ $row[6] }}" required
                                                min="0"></td>
                                        <td><input class="form-control form-control-lg" style="width:100px"
                                                type="number" id="data7a{{ $loop->index }}"
                                                name="data7a{{ $loop->index }}" value="{{ $row[7] }}" required
                                                min="0"></td>
                                        <td><input class="form-control form-control-lg" style="width:100px"
                                                type="number" id="data8a{{ $loop->index }}"
                                                name="data8a{{ $loop->index }}" step="0.00001"
                                                value="{{ $row[8] }}" required min="0"></td>
                                        <td>
                                            <select style="width:100px" class="form-select form-select-lg "
                                                id="data9a{{ $loop->index }}" id="data9a{{ $loop->index }}"
                                                name="data9a{{ $loop->index }}" value="{{ $row[9] }}" required>
                                                <option style="display: none" selected value="{{ $row[9] }}">
                                                    {{ $row[9] }}</option>
                                        ...
                                        <td>
                                            <select style="width:100px" class="form-select form-select-lg "
                                                id="data10a{{ $loop->index }}" name="data10a{{ $loop->index }}"
                                                value="{{ $row[10] }}" required>
                                                <option style="display: none" selected value="{{ $row[10] }}">
                                                    {{ $row[10] }}
                                                </option>
                                                <option value="是"> {!! __('basicInfoLang.yes') !!}</option>
                                                <option value="否">{!! __('basicInfoLang.no') !!}</option>
                                        ...
                                        <td><input class="form-control form-control-lg " style="width:100px"
                                                type="number" id="data13a{{ $loop->index }}"
                                                name="data13a{{ $loop->index }}" value="{{ $row[13] }}"
                                                min="0">
                                        </td>
