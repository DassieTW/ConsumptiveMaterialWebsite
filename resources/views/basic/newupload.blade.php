                        ...
                        <table class="table">
                            ...
                            @foreach ($data as $row)
                                <tr id="row{{ $loop->index }}">
                                    ...
                                    <td><input class="form-control form-control-lg" style="width:100px" type="text"
                                            id="data5a{{ $loop->index }}" name="data5a{{ $loop->index }}"
                                            value="{{ $row[5] }}" required>
                                    </td>
                                    <td><input class="form-control form-control-lg" style="width:100px" type="number"
                                            id="data6a{{ $loop->index }}" name="data6a{{ $loop->index }}"
                                            value="{{ $row[6] }}" required min="0"></td>
                                    <td><input class="form-control form-control-lg" style="width:100px" type="number"
                                            id="data7a{{ $loop->index }}" name="data7a{{ $loop->index }}"
                                            value="{{ $row[7] }}" required min="0"></td>
                                    <td><input class="form-control form-control-lg" style="width:100px" type="number"
                                            id="data8a{{ $loop->index }}" name="data8a{{ $loop->index }}"
                                            step="0.00001" value="{{ $row[8] }}" required min="0"></td>
                                    <td>
                                        <select style="width:100px" class="form-select form-select-lg "
