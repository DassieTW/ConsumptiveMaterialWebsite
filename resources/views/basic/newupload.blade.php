                            ...
                            <table class="table" id = "test">
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input style="width:100px" type = "text"  name = "data5a{{$loop->index}}" value = "{{$row[5]}}" required></td>
                                        <td><input style="width:100px" type = "number"  name = "data6a{{$loop->index}}" value = "{{$row[6]}}" required></td>
                                        <td><input style="width:100px" type = "number"  name = "data7a{{$loop->index}}" value = "{{$row[7]}}" required></td>
                                        <td><input style="width:100px" type = "number"  name = "data8a{{$loop->index}}"  step = "0.00001" value = "{{$row[8]}}" required></td>
                                        <td>
                                            <select style="width:100px" class="form-select form-select-lg " id = "data9a{{$loop->index}}" name="data9a{{$loop->index}}" value = "{{$row[9]}}" required>
                                        ...
                                        <td>
                                            <select style="width:100px" class="form-select form-select-lg " name="data10a{{$loop->index}}" value = "{{$row[10]}}" required>
                                        ...
                                        <td>
                                            <select style="width:100px" class="form-select form-select-lg "  name="data11a{{$loop->index}}" value = "{{$row[11]}}" required>
                                        ...
                                        <td>
                                            <select style="width:150px" class="form-select form-select-lg " name="data12a{{$loop->index}}" value = "{{$row[12]}}" required>
                                        ...
                                        <td><input style="width:100px" type = "number"  name = "data13a{{$loop->index}}" value = "{{$row[13]}}"></td>
