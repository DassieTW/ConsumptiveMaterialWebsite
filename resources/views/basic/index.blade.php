                        ...
                        <div class="tab-pane fade" id="showusedep">
                            <div class="row w-100 justify-content-center">
                                <div class="col col-auto">
                                    ...
                                    <hr />
                                    @endforeach
                                    {!! __('basicInfoLang.new') !!} : <input class="use" type="text" id="usenew"
                                        name="usenew" value="">
                                    <hr />
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="showusereason">
                            <div class="row w-100 justify-content-center">
                                <div class="col col-auto">
                                    ...
                                    <hr />
                                    @endforeach
                                    {!! __('basicInfoLang.new') !!} : <input class="usereason" type="text"
                        ...
                        <div class="tab-pane fade" id="showinreason">
                            <div class="row w-100 justify-content-center">
                                <div class="col col-auto">
                                    ...
                                    <hr />
                                    @endforeach
                                    {!! __('basicInfoLang.new') !!} : <input class="inreason" type="text"
                        ...
                        <div class="tab-pane fade" id="showloc">
                            <div class="row w-100 justify-content-center">
                                <div class="col col-auto">
                                    ...
                                    <hr />
                                    @endforeach
                                    {!! __('basicInfoLang.new') !!} : <input class="position" type="text"
