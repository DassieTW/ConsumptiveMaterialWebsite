...
<div class="card">
    ...
    <div class="card-body">
                ...
                <table class="table" id="pickrecordlist">
                    <tr >
                        <th><input type="hidden" id="title0" name="title0" value="客戶別">{!! __('oboundpageLang.client')
                            !!}</th>
                        <th><input type="hidden" id="title1" name="title1" value="機種">{!! __('oboundpageLang.machine')
                            !!}</th>
                        <th><input type="hidden" id="title2" name="title2" value="製程">{!! __('oboundpageLang.process')
                            !!}</th>
                        <th><input type="hidden" id="title3" name="title3" value="退回原因">{!!
                            __('oboundpageLang.backreason') !!}</th>
                        <th><input type="hidden" id="title4" name="title4" value="線別">{!! __('oboundpageLang.line') !!}
                        </th>
                        <th><input type="hidden" id="title5" name="title5" value="料號">{!! __('oboundpageLang.isn') !!}
                        </th>
                        <th><input type="hidden" id="title6" name="title6" value="品名">{!! __('oboundpageLang.pName') !!}
                        </th>
                        <th><input type="hidden" id="title7" name="title7" value="規格">{!! __('oboundpageLang.format')
                            !!}</th>
                        <th><input type="hidden" id="title8" name="title8" value="預退數量">{!!
                            __('oboundpageLang.backamount') !!}</th>
                        <th><input type="hidden" id="title9" name="title9" value="實際退回數量">{!!
                            __('oboundpageLang.realbackamount') !!}</th>
                        <th><input type="hidden" id="title10" name="title10" value="備註">{!! __('oboundpageLang.mark')
                            !!}</th>
                        <th><input type="hidden" id="title11" name="title11" value="實退差異原因">{!!
                            __('oboundpageLang.backdiffreason') !!}</th>
                        <th><input type="hidden" id="title12" name="title12" value="庫別">{!! __('oboundpageLang.bound')
                            !!}</th>
                        <th><input type="hidden" id="title13" name="title13" value="收料人員">{!!
                            __('oboundpageLang.receivepeople') !!}</th>
                        <th><input type="hidden" id="title14" name="title14" value="收料人員工號">{!!
                            __('oboundpageLang.receivepeoplenum') !!}</th>
                        <th><input type="hidden" id="title15" name="title15" value="退料人員">{!!
                            __('oboundpageLang.backpeople') !!}</th>
                        <th><input type="hidden" id="title16" name="title16" value="退料人員工號">{!!
                            __('oboundpageLang.backpeoplenum') !!}</th>
                        <th><input type="hidden" id="title17" name="title17" value="退料單號">{!!
                            __('oboundpageLang.backlistnum') !!}</th>
                        <th><input type="hidden" id="title18" name="title18" value="開單時間">{!!
                            __('oboundpageLang.opentime') !!}</th>
                        <th><input type="hidden" id="title19" name="title19" value="入庫時間">{!!
                            __('oboundpageLang.inboundtime') !!}</th>
                        <th><input type="hidden" id="title20" name="title20" value="功能狀況">{!!
                            __('oboundpageLang.status') !!}</th>
        ...
        <button class="btn btn-lg btn-primary" onclick="location.href='{{route('obound.backrecord')}}'">{!!
