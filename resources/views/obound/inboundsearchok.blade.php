...
@section('js')
    <script src="{{ asset('js/obound/inboundsearch.js?v=') . env('APP_VERSION') }}"></script>
@endsection
@section('content')
                ...
                <form id="inboundsearch" method="POST">
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <th><input type="hidden" id="title0" name="title0" value="入庫單號">{!! __('oboundpageLang.inlist') !!}
                            </th>
                            ...
                            <th><input type="hidden" id="title4" name="title4" value="客戶別">{!! __('oboundpageLang.client') !!}
                            </th>
                            <th><input type="hidden" id="title5" name="title5" value="庫別">{!! __('oboundpageLang.bound') !!}
                            </th>
                            <th><input type="hidden" id="title6" name="title6" value="數量">{!! __('oboundpageLang.inboundnum') !!}
                            </th>
                            <th><input type="hidden" id="title7" name="title7" value="入庫人員">{!! __('oboundpageLang.inpeople') !!}
                            </th>
                            <th><input type="hidden" id="title8" name="title8" value="時間">{!! __('oboundpageLang.inboundtime') !!}
                            </th>
                            <th><input type="hidden" id="title9" name="title9" value="備註">{!! __('oboundpageLang.mark') !!}
                            </th>
                            <th><input type="hidden" id="title10" name="title10" value="入庫原因">{!! __('oboundpageLang.inreason') !!}
                            </th>
