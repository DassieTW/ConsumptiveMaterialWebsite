    ...
    <div class="card-body">
        <form id="picklist">
            ...
            <div class="table-responsive">
                <table class="table" id="picklisttable">
                    <tbody id="picklistbody">
                        ...
                        <tr>
                            <?php
                                        $stock = DB::table('O庫inventory')->where('料號',$data->料號)->where('客戶別',$data->客戶別)->pluck('現有庫存')->toArray();
                                        $bound = DB::table('O庫inventory')->where('料號',$data->料號)->where('客戶別',$data->客戶別)->pluck('庫別')->toArray();
            ...
            <ul id="sendmenu" style="display: none;" class="list-group">
                ...
                <a class="sendlist list-group-item list-group-item-action" href="#">{{ $people->工號 .' '. $people->姓名
                    }}</a>
                <div class="w-100" style="height: 1ch;"></div><!-- </div>breaks cols to a new line-->
                @endforeach
            </ul>
            ...
            <ul id="pickmenu" style="display: none;" class="list-group">
                ...
                <a class="picklist list-group-item list-group-item-action" href="#">{{ $people->工號 .' '. $people->姓名
                    }}</a>
                <div class="w-100" style="height: 1ch;"></div><!-- </div>breaks cols to a new line-->
                @endforeach
            </ul>
