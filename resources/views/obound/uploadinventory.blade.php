...
<div class="card">
    ...
    <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table" id="test">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control form-control-lg" id="data4{{$loop->index}}" type="number"
                                name="data4{{$loop->index}}" value="{{$row[2]}}" min="1" required></td>
                        <td>
                            <input class="form-control form-control-lg" id="data5{{$loop->index}}" type="text"
                                name="data5{{$loop->index}}" value="{{$row[3]}}" required></td>
                        </td>
                    </tr>
        ...
        <button class="btn btn-lg btn-primary" onclick="location.href='{{route('obound.upload')}}'">{!!
