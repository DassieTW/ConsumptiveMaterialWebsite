...
@section('js')
    ...
    <script src="{{ asset('js/obound/new.js?v=') . env('APP_VERSION') }}"></script>
@endsection
@section('content')
                    ...
                    <div class="card-body">
                        <div class=" w-100">
                            <form method="post" enctype="multipart/form-data"
                                action="{{ route('obound.uploadmaterial') }}">
                                @csrf
                                <div class="row w-100 justify-content-center mb-3">
                                    <div class="col col-auto ">
                                        <a href="{{ asset('download/OMaterialExample.xlsx') }}"
                                            download>{!! __('oboundpageLang.exampleExcel') !!}</a>
                                    </div>
