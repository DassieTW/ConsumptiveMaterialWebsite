...
@section('js')
    <script src="{{ asset('js/obound/searchstockok.js?v=') . env('APP_VERSION') }}"></script>
@endsection
@section('content')
    <div id="mountingPoint">
        ...
        <div class="card">
            <div class="card-body">
                <form id="oboundsearch" method="POST">
                    @csrf
                    <input type="submit" id="download" name="download" class="btn btn-lg btn-primary"
                        value="{!! __('oboundpageLang.download') !!}">
                    <div class="w-100" style="height: 1ch;"></div><!-- </div>breaks cols to a new line-->

                    <input type="hidden" id="titlename" name="titlename" value="O庫庫存">

                    <obound-stock-table></obound-stock-table>
