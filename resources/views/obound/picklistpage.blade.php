...
@section('content')
    @if ($num > 0)
        <audio controls autoplay hidden>
            <source id="audio_1" src="{{ __('outboundpageLang.audio.Opicklist') }}" type="audio/mpeg">
        </audio>
    @endif
                        ...
                        <div class="row w-100 justify-content-center mb-3">
                            ...
                            <div class="col-lg-6  col-md-12 col-sm-12">
                                ...
                                <select class="form-select form-select-lg" id="list" name="list" required>
                                    <option style="display: none" disabled selected value="">{!! __('oboundpageLang.enterpicklist') !!}
                                    </option>
