    ...
    <div class="card">
        ...
        <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table" id="pickrecordlist">
                        <tr>
                            ...
                            <th><input type="hidden" id="title3" name="title3" value="領用原因">{!! __('oboundpageLang.usereason') !!}
                            </th>
                            ...
                            <th><input type="hidden" id="title8" name="title8" value="預領數量">{!! __('oboundpageLang.pickamount') !!}
                            </th>
                            <th><input type="hidden" id="title9" name="title9" value="實際領用數量">{!! __('oboundpageLang.realpickamount') !!}
                            </th>
                            <th><input type="hidden" id="title10" name="title10" value="備註">{!! __('oboundpageLang.mark') !!}
                            </th>
                            <th><input type="hidden" id="title11" name="title11" value="實領差異原因">{!! __('oboundpageLang.diffreason') !!}
                            </th>
                            <th><input type="hidden" id="title12" name="title12" value="庫別">{!! __('oboundpageLang.bound') !!}
                            </th>
                            <th><input type="hidden" id="title13" name="title13" value="領料人員">{!! __('oboundpageLang.pickpeople') !!}
                            </th>
                            <th><input type="hidden" id="title14" name="title14" value="領料人員工號">{!! __('oboundpageLang.pickpeoplenum') !!}
                            </th>
                            <th><input type="hidden" id="title15" name="title15" value="發料人員">{!! __('oboundpageLang.sendpeople') !!}
                            </th>
                            ...
                            <th><input type="hidden" id="title19" name="title19"
                                    value="出庫時間">{!! __('oboundpageLang.outboundtime') !!}</th>
            ...
            <button class="btn btn-lg btn-primary"
                onclick="location.href='{{ route('obound.pickrecord') }}'">{!! __('oboundpageLang.return') !!}</button>
        </div>
    </div>
@endsection
