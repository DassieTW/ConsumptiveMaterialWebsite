                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="chart">
                                        ...
                                        <canvas id="chartjs-radar" width="832" height="375" style="display: block; height: 300px; width: 666px;" class="chartjs-render-monitor"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="chart">
                                        ...
                                        <canvas id="chartjs-polar-area" width="832" height="375" style="display: block; height: 300px; width: 666px;" class="chartjs-render-monitor"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
