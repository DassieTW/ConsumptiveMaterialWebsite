            ...
            <div class="card-body">
                <div class="d-flex w-100 h-100">
                    ...
                    <form action = "{{ route('member.searchusername') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label">{!! __('loginPageLang.loginsearch') !!}</label>
                            <input class="form-control form-control-lg @error('number') is-invalid @enderror" type="text" id ="username" name="username" placeholder="{!! __('loginPageLang.enterlogin') !!}"/>
                        </div>
