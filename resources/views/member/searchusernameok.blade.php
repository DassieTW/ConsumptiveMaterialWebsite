    ...
    <div id="mountingPoint">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @can('canAddSitesToUser', App\Models\Login::class)
                    {{-- Modal --}}
                    <div class="modal fade" id="siteListPicker" aria-hidden="true" aria-labelledby="siteListPicker"
                        tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" id="DeleteUser" class="btn btn-danger"
                                        data-bs-target="#AreYouSureModal" data-bs-toggle="modal">Delete
                                        This User</button>
