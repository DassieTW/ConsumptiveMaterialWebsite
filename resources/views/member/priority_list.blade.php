                    ...
                    <table class="table table-sm table-bordered" style="white-space:nowrap;">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th colspan="2">{!! __('loginPageLang.priority') . ' 3' !!}</th>
                                <th colspan="2">{!! __('loginPageLang.priority') . ' 2' !!}</th>
                                <th colspan="2">{!! __('loginPageLang.priority') . ' 1' !!}</th>
                            </tr>
                        </thead>
                        <tbody>
                            {{-- 基礎資料 --}}
                            <tr>
                                {{-- 4 --}}
                                <td rowspan="3" class="table-secondary">
                                    ...
                                    <span
                                        class="align-middle text-decoration-line-through text-muted">{!! __('templateWords.basicInfo') !!}</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td rowspan="3" class="table-secondary">
                                    ...
                                    <span
                                        class="align-middle text-decoration-line-through text-muted">{!! __('templateWords.callsys') !!}</span>
                                </td>
                                <td class="table-secondary"><span
                                        class="text-decoration-line-through text-muted">{!! __('callpageLang.safealert') !!}</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td rowspan="4" class="table-success">
                                    ...
                                    <span
                                        class="align-middle">{!! __('templateWords.userManage') !!}</span>
                                </td>
                                <td class="table-secondary"><span
                                        class="text-decoration-line-through text-muted">{!! __('templateWords.UserInfo') !!}</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="table-success">
                                    <span">{!! __('loginPageLang.permission_details') !!}</span>
                                </td>
                                {{-- 3 --}}
                                <td class="table-success"><span>{!! __('loginPageLang.permission_details') !!}</span></td>
                                {{-- 2 --}}
                                <td class="table-success"><span>{!! __('loginPageLang.permission_details') !!}</span></td>
                                {{-- 1 --}}
                                <td class="table-success"><span>{!! __('loginPageLang.permission_details') !!}</span></td>
