    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex text-gray-900 dark:text-white justify-center pt-8 sm:pt-0">
                <p class="font-semibold" style="font-size: 3rem;">
            ...
            <div class="flex text-gray-900 dark:text-white justify-center pt-8 sm:pt-0">
                <p style="font-size: 2rem;">
                    System has been moved to a new URL
                </p>
            </div>
            <div class="flex text-gray-900 dark:text-white justify-center pt-8 sm:pt-0">
                <a class="col col-6 btn btn-info btn-lg font-semibold" style="font-size: 2rem;"
                    href="https://ptwsiteservice01.pega.corp.pegatron" role="button">
                    ➤➤ GO ➤➤
                </a>
            </div>
            <div class="flex justify-center mt-4 sm:items-center">
                <div class="col col-auto text-center text-sm text-gray-500" style="">
