...
@section('js')
<script src="{{ asset('/js/barcode/barcode_gen_from_db.js') }}"></script>
        ...
        <div class="col-auto ml-auto text-right mt-n1 d-none d-sm-block">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    <li class="breadcrumb-item"><a href="#shouldbeDashboard">{!! __('templateWords.websiteName') !!}</a></li>
                    <li class="breadcrumb-item"><a href="#">{!! __('templateWords.barcode_gen') !!}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{!! __('templateWords.barcode_generator') !!}</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <form class="text-center needs-validation" id="isnForm" method="post" accept-charset="utf-8"
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col col-auto p-0 m-0">
                                <label for="isn" class="col-form-label">{!! __('barcodeGenerator.isn') !!}:&nbsp;</label>
                            </div>
                            <div class="col col-auto p-0 m-0">
                                <div class="input-group has-validation col col-auto">
                                    <input type="text" id="barcode1" name="barcode1" class="form-control p-1"
                                        maxlength="4" style="width: 7ch; text-align: center;" placeholder="1234" pattern="[0-9A-Za-z]{4,4}"
                                        required>
                        ...
                        <div class="row justify-content-center align-items-center mt-3">
                            <div class="col col-auto p-0 m-0">
                                <label for="isn" class="col-form-label">{!! __('barcodeGenerator.pName') !!}:&nbsp;</label>
                            </div>
                            <div class="col col-auto p-0">
                                <input type="text" id="pName" name="pName" class="form-control p-1" maxlength="15"
                                    style="width: 15ch; text-align: center;" placeholder="{!! __('barcodeGenerator.electric_screwdriver_bits') !!}" required>
        ...
        <div class="col-12">
            <div class="card flex-fill w-100">
                <div class="card-body pt-2 pb-3">
                    ...
                    <form class="text-center needs-validation" id="locForm" method="post"
                        accept-charset="utf-8" novalidate autocomplete="off">
                        @csrf
                        <div class="row justify-content-center align-items-center">
                            <div class="col col-auto p-0 m-0">
                                <label for="savePott" class="col-form-label">{!! __('barcodeGenerator.loc') !!}:&nbsp;</label>
                            </div>

                            <div class="col col-auto p-0">
                                <input type="text" name="barcode3"
                                    class="form-control p-1" id="barcode3"
                                    maxlength="11" style="width: 11ch; text-align: center;" placeholder="7-A000"
