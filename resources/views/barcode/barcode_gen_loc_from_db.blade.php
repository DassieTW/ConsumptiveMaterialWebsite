...
@section('js')
    <script src="{{ asset('/js/barcode/barcode_search_loc_page.js?v=') . env('APP_VERSION') }}"></script>
@endsection
                        ...
                        <form class="text-center needs-validation" id="searchForm" method="post" accept-charset="utf-8"
                            ...
                            <div class="row justify-content-center align-items-center">
                                <div class="col col-auto p-0 m-0">
                                    <label for="searchIn"
                                        class="col-form-label">{!! __('barcodeGenerator.search_loc') !!}:&nbsp;&nbsp;</label>
                                </div>

                                <div class="col col-auto p-0">
                                    <input type="text" name="searchIn" class="form-control p-1" id="searchIn"
                                        maxlength="12" style="width: 15ch; text-align: center;" placeholder="7-..."
