                ...
                <table class="table" id="backlisttable">
                    <tbody id="backlistbody">
                        ...
                        <tr>
                            <?php
                                $showstock  = '';
                                $nowstock = DB::table('inventory')->where('料號', $data->料號)->where('客戶別',  $data->客戶別)->where('現有庫存', '>', 0)->pluck('現有庫存')->toArray();
                                $nowloc = DB::table('inventory')->where('料號',  $data->料號)->where('客戶別',  $data->客戶別)->where('現有庫存', '>', 0)->pluck('儲位')->toArray();
                            ...
                            <td>
                                <select style="width: 150px" class="form-select form-select-lg"
                                    name="position{{$loop->index}}" id="position{{$loop->index}}" required>
