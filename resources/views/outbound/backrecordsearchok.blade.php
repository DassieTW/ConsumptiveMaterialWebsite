            ...
            <div class="table-responsive">
                <table class="table" id="pickrecordlist">
                    ...
                    <tr id="{{$data->退料單號}}">
                        ...
                        <td><input type="hidden" id="data11{{$loop->index}}" name="data11{{$loop->index}}"
                                value="{{$data->備註}}">{{$data->備註}}</td>
                        <td><input type="hidden" id="data12{{$loop->index}}" name="data12{{$loop->index}}"
                                value="{{$data->實退差異原因}}">{{$data->實退差異原因}}</td>
                        <td><input type="hidden" id="data13{{$loop->index}}" name="data13{{$loop->index}}"
                                value="{{$data->儲位}}">{{$data->儲位}}</td>
                        <td><input type="hidden" id="data14{{$loop->index}}" name="data14{{$loop->index}}"
                                value="{{$data->收料人員}}">{{$data->收料人員}}</td>
                        <td><input type="hidden" id="data15{{$loop->index}}" name="data15{{$loop->index}}"
                        ...
                        <td><input type="hidden" id="data19{{$loop->index}}" name="data19{{$loop->index}}"
                                value="{{$data->開單時間}}">{{$data->開單時間}}</td>
                        <td><input type="hidden" id="data20{{$loop->index}}" name="data20{{$loop->index}}"
