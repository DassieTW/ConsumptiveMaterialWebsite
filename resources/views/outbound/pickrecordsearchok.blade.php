        ...
        <div class="card-body">
            <form id="picktable" method="POST">
                ...
                {{-- <button class="btn btn-lg btn-primary"
                    onclick="location.href='{{ route('outbound.pickrecord') }}'">{!! __('outboundpageLang.return')
                    !!}</button> --}}
                <outbound-pickrecord-table></outbound-pickrecord-table> {{-- <div class="table-responsive text-nowrap">
                    <table class="table" id="pickrecordlist">
                        <thead>
                            <tr>
                                <th><input type="hidden" id="title0" name="title0" value="客戶別">{!!
                                    __('outboundpageLang.client') !!}</th>
                                <th><input type="hidden" id="title1" name="title1" value="機種">{!!
                                    __('outboundpageLang.machine') !!}</th>
                                <th><input type="hidden" id="title2" name="title2" value="製程">{!!
                                    __('outboundpageLang.process') !!}</th>
                                <th><input type="hidden" id="title3" name="title3" value="領用原因">{!!
                                    __('outboundpageLang.usereason') !!}</th>
                                <th><input type="hidden" id="title4" name="title4" value="線別">{!!
                                    __('outboundpageLang.line') !!}</th>
                                <th><input type="hidden" id="title5" name="title5" value="料號">{!!
                                    __('outboundpageLang.isn')
                                    !!}</th>
                                <th><input type="hidden" id="title6" name="title6" value="品名">{!!
                                    __('outboundpageLang.pName') !!}</th>
                                <th><input type="hidden" id="title7" name="title7" value="規格">{!!
                                    __('outboundpageLang.format') !!}</th>
                                <th><input type="hidden" id="title8" name="title8" value="單位">{!!
                                    __('outboundpageLang.unit') !!}</th>
                                <th><input type="hidden" id="title9" name="title9" value="預領數量">{!!
                                    __('outboundpageLang.pickamount') !!}
                                </th>
                                <th><input type="hidden" id="title10" name="title10" value="實際領用數量">{!!
                                    __('outboundpageLang.realpickamount') !!}
                                </th>
                                <th><input type="hidden" id="title11" name="title11" value="備註">{!!
                                    __('outboundpageLang.mark') !!}
                                </th>
                                <th><input type="hidden" id="title12" name="title12" value="實領差異原因">{!!
                                    __('outboundpageLang.diffreason') !!}
                                </th>
                                <th><input type="hidden" id="title13" name="title13" value="儲位">{!!
                                    __('outboundpageLang.loc') !!}
                                </th>
                                <th><input type="hidden" id="title14" name="title14" value="領料人員">{!!
                                    __('outboundpageLang.pickpeople') !!}
                                </th>
                                <th><input type="hidden" id="title15" name="title15" value="領料人員工號">{!!
                                    __('outboundpageLang.pickpeoplenum') !!}
                                </th>
                                <th><input type="hidden" id="title16" name="title16" value="發料人員">{!!
                                    __('outboundpageLang.sendpeople') !!}
                                </th>
                                <th><input type="hidden" id="title17" name="title17" value="發料人員工號">{!!
                                    __('outboundpageLang.sendpeoplenum') !!}
                                </th>
                                <th><input type="hidden" id="title18" name="title18" value="領料單號">{!!
                                    __('outboundpageLang.picklistnum') !!}
                                </th>
                                <th><input type="hidden" id="title19" name="title19" value="開單時間">{!!
                                    __('outboundpageLang.opentime') !!}
                                </th>
                                <th><input type="hidden" id="title20" name="title20" value="出庫時間">{!!
                                    __('outboundpageLang.outboundtime') !!}
                                </th>
