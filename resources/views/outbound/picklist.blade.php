            ...
            <div class="card-body">
                <form id = "picklist">
                    ...
                    <div class="table-responsive">
                            ...
                            <option style="display: none" disabled selected value = "">{!! __('outboundpageLang.enterpickpeople') !!}</option>
                        ...
                        <br>
                <button class="btn btn-lg btn-primary" onclick="location.href='{{route('outbound.picklistpage')}}'">{!! __('outboundpageLang.return') !!}</button>
            </div>
        </div>
</html>
@endsection
