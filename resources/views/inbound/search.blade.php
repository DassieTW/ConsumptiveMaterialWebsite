                    ...
                    <div class="card-body">
                        ...
                        <form id="form1" method="POST">
                            ...
                            <div class="row w-100 justify-content-center mb-3">
                                ...
                                <label class="col col-auto form-label">{!! __('inboundpageLang.inlist') !!}</label>
                                <div class="w-100" style="height: 1ch;"></div><!-- </div>breaks cols to a new line-->
                                <div class="col-lg-6  col-md-12 col-sm-12">

                                    <input class="form-control form-control-lg @error('innumber') is-invalid @enderror"
                                        type="number" id="innumber" name="innumber" placeholder="{!! __('inboundpageLang.enterinlist') !!}"
                                        oninput="if(value.length>12)value=value.slice(0,12)">
                                    <div id="innumbererror" style="display:none; color:red;">{!! __('validation.regex') !!}</div>
                                </div>
                                ...
                                <div class="row w-100 justify-content-center">
                                    <div class="col col-auto">
                                        <input class="basic" type="checkbox" id="date" name="date"
                                            style="width:20px;height:20px;"> {!! __('inboundpageLang.timepart') !!}
                                    </div>
                                </div>
                                <div class="w-100" style="height: 1ch;"></div><!-- </div>breaks cols to a new line-->
                                <div class="row w-100 justify-content-center">
