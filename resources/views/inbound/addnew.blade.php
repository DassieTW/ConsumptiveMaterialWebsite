    ...
    <head>
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <table class="table" id = "inboundsearch">
                        <tr id = "">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control form-control-lg" id = "newposition" name="newposition" required>
                ...
                <br>
                <button type = "submit" class="btn btn-lg btn-primary" onclick="location.href='{{route('inbound.add')}}'">{!! __('inboundpageLang.return') !!}</button>
            </div>
        </div>
</html>
@endsection
