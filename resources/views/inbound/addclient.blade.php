                ...
                <div class="d-flex w-100 h-100">
                    <div class="mb-3">
                            ...
                            <table class="table" id = "test">
                                <tr id = "require">
                                    ...
                                    <tr id = "{{$loop->index}}">
                                        ...
                                        <td><input type = "hidden" id = "name{{$loop->index}}" name = "name{{$loop->index}}" value = "{{$name}}">{{$name}}</td>
                                        <td><input type = "hidden" id = "format{{$loop->index}}" name = "format{{$loop->index}}" value = "{{$format}}">{{$format}}</td>
                                        <td><input type = "hidden" id = "unit{{$loop->index}}" name = "unit{{$loop->index}}" value = "{{$unit}}">{{$unit}}</td>
                                        <td><input type = "hidden" id = "buyamount{{$loop->index}}" name = "buyamount{{$loop->index}}" value = "{{$data->請購數量}}">{{$data->請購數量}}</td>
                                        <td><input type = "hidden" id = "stock{{$loop->index}}" name = "stock{{$loop->index}}" value = "{{$stock}}">{{$stock}}</td>
                                        <td>{{$safe}}</td>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <option style="display: none" disabled selected value = "">{!! __('inboundpageLang.enterinpeople') !!}</option>
