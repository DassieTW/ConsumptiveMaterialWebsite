                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th><input type="hidden" id="title10" name="title10" value="月使用量">{!! __('inboundpageLang.monthuse') !!}
                                </th>
                                <th><input type="hidden" id="title11" name="title11" value="庫存使用月數">{!! __('inboundpageLang.stockmonth') !!}
                                </th>
