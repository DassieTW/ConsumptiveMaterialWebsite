                ...
                <div class="table-responsive">
                        ...
                        <table class="table">
                            <tr id = "require">
                                ...
                                <th><input type = "hidden" id = "title4" name = "title4" value = "單位">{!! __('inboundpageLang.unit') !!}</th>
                                <th><input type = "hidden" id = "title5" name = "title5" value = "單價">{!! __('inboundpageLang.price') !!}</th>
                                <th><input type = "hidden" id = "title6" name = "title6" value = "幣別">{!! __('inboundpageLang.money') !!}</th>
                                <th><input type = "hidden" id = "title7" name = "title7" value = "A級資材">{!! __('inboundpageLang.gradea') !!}</th>
                                <th><input type = "hidden" id = "title8" name = "title8" value = "月請購">{!! __('inboundpageLang.month') !!}</th>
                                <th><input type = "hidden" id = "title9" name = "title9" value = "現有庫存">{!! __('inboundpageLang.nowstock') !!}</th>
                                ...
                                <tr class="isnRows">
                                    ...
                                    ?>
                                    <td><input type = "hidden" id = "dataa{{$loop->index}}" name = "data0{{$loop->index}}" value = "{{$data->客戶別}}">{{$data->客戶別}}</td>
                                    <td><input type = "hidden" id = "datab{{$loop->index}}" name = "data1{{$loop->index}}" value = "{{$data->料號}}">{{$data->料號}}</td>
                                    ...
                                    <td><input type = "hidden" id = "dataj{{$loop->index}}" name = "data9{{$loop->index}}" value = "{{round($data->現有庫存,0)}}">{{round($data->現有庫存,0)}}</td>
                                    <td><input type = "hidden" id = "datak{{$loop->index}}" name = "data10{{$loop->index}}" value = "{{$monthuse}}">{{$monthuse}}</td>
                                    <td><input type = "hidden" id = "datal{{$loop->index}}" name = "data11{{$loop->index}}" value = "{{round($stockmonth,1)}}">{{round($stockmonth , 1)}}</td>
                                </tr>
