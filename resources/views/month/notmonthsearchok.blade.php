                        ...
                        <thead>
                            <tr>
                                ...
                                <th><input type="hidden" id="title1" name="title1" value="料號">{!!
                                    __('monthlyPRpageLang.isn') !!}</td>
                                <th><input type="hidden" id="title2" name="title2" value="品名">{!!
                                    __('monthlyPRpageLang.pName') !!}</td>
                                <th><input type="hidden" id="title3" name="title3" value="請購數量">{!!
                                    __('monthlyPRpageLang.buyamount1') !!}</td>
                                <th><input type="hidden" id="title4" name="title4" value="上傳時間">{!!
                                    __('monthlyPRpageLang.uploadtime') !!}</td>
                                <th><input type="hidden" id="title5" name="title5" value="說明">{!!
                                    __('monthlyPRpageLang.description') !!}</td>
                                <th><input type="hidden" id="title6" name="title6" value="SXB單號">{!!
                                    __('monthlyPRpageLang.sxb') !!}</td>
