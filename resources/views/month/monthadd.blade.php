                    ...
                    <div class="mb-3">
                        <table class="table" id ="month">
                            ...
                            @foreach($production as $production)
                                ...
                                <td><input type="hidden" id ="production{{$loop->index}}" name="production{{$loop->index}}" value="{{$production}}">{{ $production }}</td>
                                <td><input style="width:70px" type="number" id ="nextmps{{$loop->index}}" name="nextmps{{$loop->index}}" required value="{{$nextmps}}"></td>
                                <td><input style="width:70px" type="number" id ="nextday{{$loop->index}}" name="nextday{{$loop->index}}" required value="{{$nextday}}"></td>
                                <td><input style="width:70px" type="number" id ="nowmps{{$loop->index}}" name="nowmps{{$loop->index}}" required value="{{$nowmps}}"></td>
                                <td><input style="width:70px" type="number" id ="nowday{{$loop->index}}" name="nowday{{$loop->index}}" required value="{{$nowday}}"></td>
                                </tr>
