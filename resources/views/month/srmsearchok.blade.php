                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input class = "form-control form-control-lg" style="width:150px" type="text" id="sxbnumber{{$loop->index}}"
                                name="sxbnumber{{$loop->index}}" placeholder="{!! __('monthlyPRpageLang.entersxb') !!}"></td>
                        ...
                        <td><input class = "form-control form-control-lg"  style="width:120px" type="number" id="sxbamount{{$loop->index}}"
                                name="sxbamount{{$loop->index}}" required value="{{$data->本次請購數量}}" min = "0" max = "{{$data->本次請購數量}}"></td>
                        <td>{{$data->MOQ}}</td>
                        <td>{{$data->下月需求}}</td>
                        <td>{{$data->當月需求}}</td>
                        <td>{{$data->安全庫存}}</td>
