            ...
            <div class="card-body">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <tr>
                                    <td><input style="width:100px" type="text" id ="sxbnumber{{$loop->index}}" name="sxbnumber{{$loop->index}}" required placeholder="請輸入SXB單號"></td>
                                    <td><input type = "hidden" id = "srmnumber{{$loop->index}}" name = "srmnumber{{$loop->index}}" value = "{{$data->SRM單號}}">{{$data->SRM單號}}</td>
