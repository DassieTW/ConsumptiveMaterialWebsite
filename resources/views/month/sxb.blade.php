                    ...
                    <div class="d-flex w-100">
                        <form id="form1" method="POST">
                            ...
                            <div class="row w-100 justify-content-center mb-3">
                                ...
                                <label class="col col-auto form-label p-0 m-0">{!! __('monthlyPRpageLang.isn')
                                    !!}</label>
                                <div class="w-100" style="height: 0ch;"></div><!-- </div>breaks cols to a new line-->
                                <div class="col-lg-6  col-md-12 col-sm-12">
                                ...
                                <label class="col col-auto form-label p-0 m-0">{!! __('monthlyPRpageLang.sxb')
                                    !!}</label>
                                <div class="w-100" style="height: 0ch;"></div><!-- </div>breaks cols to a new line-->
                                <div class="col-lg-6  col-md-12 col-sm-12">
                                ...
                                <label class="col col-auto form-label p-0 m-0">{!! __('monthlyPRpageLang.senddep')
                                    !!}</label>
                                <div class="w-100" style="height: 0ch;"></div><!-- </div>breaks cols to a new line-->
                                <div class="col-lg-6  col-md-12 col-sm-12">
