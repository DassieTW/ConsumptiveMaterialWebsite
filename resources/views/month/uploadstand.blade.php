                    ...
                    <form id="uploadstand" method="POST">
                            ...
                            <table class="table" id="test">
                                <tr>
                                    ...
                                    <th><input type="hidden" id="title8" name="title8" value="當月每人每日需求量"
                                            step="0.0000001" class="form-control form-control-lg">{!!
                                ...
                                <tr id="row{{$loop->index}}">
                                    <?php
                                            ...
                                            $unit = DB::table('consumptive_material')->where('料號',$row[0])->value('單位');
                                            $mpq = DB::table('consumptive_material')->where('料號',$row[0])->value('MPQ');
                                            $lt = DB::table('consumptive_material')->where('料號',$row[0])->value('LT');                            $lt = round($lt, 3);
                                        ?>
                        ...
                        <div class="input-group" style="width: 410px">
                            <input type="text" id="email" name="email" class="form-control form-control"
                                style="width: 150px" placeholder="{!! __('loginPageLang.enter_email') !!}" required>
