        ...
        <form id="standnew">
            ...
            <div class="row">
                <div class="mb-3 col-md-4">
                    ...
                    <input class="form-control form-control-lg" type="text" id="number" name="number" readonly
                        value="{{ Session::get('number') }}">
                </div>

                <div class="mb-3 col-md-4">
                    <label class="form-label">{!! __('monthlyPRpageLang.pName') !!}</label>
                    <input class="form-control form-control-lg " type="text" id="name" name="name" readonly
                        value="{{ Session::get('name') }}">
                </div>

                <div class="mb-3 col-md-4">
                    <label class="form-label">{!! __('monthlyPRpageLang.unit') !!}</label>
                    <input class="form-control form-control-lg " type="text" id="unit" name="unit" readonly
                        value="{{ Session::get('unit') }}">
                </div>

                <div class="mb-3 col-md-4">
                    <label class="form-label">{!! __('monthlyPRpageLang.mpq') !!}</label>
                    <input class="form-control form-control-lg " type="text" id="mpq" name="mpq" readonly
                        value="{{ Session::get('mpq') }}">
                </div>

                <div class="mb-3 col-md-4">
                    <label class="form-label">{!! __('monthlyPRpageLang.client') !!}</label>
                    <input class="form-control form-control-lg " type="text" id="client" name="client" readonly
                        value="{{ Session::get('client') }}">
                </div>

                <div class="mb-3 col-md-4">
                    <label class="form-label">{!! __('monthlyPRpageLang.machine') !!}</label>
                    <input class="form-control form-control-lg " type="text" id="machine" name="machine" readonly
                        value="{{ Session::get('machine') }}">
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <input class="form-control form-control-lg " type="text" id="lt" name="lt" readonly
                        value="{{ Session::get('lt') }}">
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <input class="form-control form-control-lg " type="text" id="production" name="production" readonly
                        value="{{ Session::get('production') }}">
                </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <input class="form-control form-control-lg " type="email" id="email" name="email"
                        pattern=".+@pegatroncorp\.com" required placeholder="xxx@pegartoncorp.com">
                </div>
            </div>
