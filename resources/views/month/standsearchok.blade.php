                        ...
                        <thead>
                            <tr>
                                ...
                                <th><input type="hidden" id="title1" name="title1" value="品名">{!!
                                    ...
                                    !!}</th>
                                <th><input type="hidden" id="title2" name="title2" value="單位">{!!
                                    __('monthlyPRpageLang.unit')
                                    !!}</th>
                                <th><input type="hidden" id="title3" name="title3" value="MPQ">{!!
                                    __('monthlyPRpageLang.mpq')
                                    !!}</th>
                                <th><input type="hidden" id="title4" name="title4" value="LT">{!!
                                    __('monthlyPRpageLang.lt') !!}
                                </th>
                    ...
                    ?>
                            <tr class="isnRows">
                                ...
                                <td><input style="width:100px" class="form-control form-control-lg" type="number"
                                        id="datai{{$loop->index}}" name="datai{{$loop->index}}"
                                        value="{{$data->當月站位人數}}" step="0.0000001" min="0"></td>
                                <td><input style="width:100px" class="form-control form-control-lg" type="number"
                                        id="dataj{{$loop->index}}" name="dataj{{$loop->index}}" value="{{$data->當月開線數}}"
                                        step="0.0000001" min="0"></td>
                                <td><input style="width:100px" class="form-control form-control-lg" type="number"
                                        id="datak{{$loop->index}}" name="datak{{$loop->index}}" value="{{$data->當月開班數}}"
                                        step="0.0000001" min="0"></td>
                                <td><input style="width:100px" class="form-control form-control-lg" type="number"
                                        id="datal{{$loop->index}}" name="datal{{$loop->index}}"
                                        value="{{$data->當月每人每日需求量}}" step="0.0000001" min="0">
                                </td>
                                <td><input style="width:100px" class="form-control form-control-lg" type="number"
                                        id="datam{{$loop->index}}" name="datam{{$loop->index}}"
                                        value="{{$data->當月每日更換頻率}}" step="0.0000001" min="0">
                                </td>
                                ...
                                <td><input style="width:100px" class="form-control form-control-lg" type="number"
                                        id="datao{{$loop->index}}" name="datao{{$loop->index}}"
                                        value="{{$data->下月站位人數}}" step="0.0000001" min="0">
                                </td>
                                <td><input style="width:100px" class="form-control form-control-lg" type="number"
                                        id="datap{{$loop->index}}" name="datap{{$loop->index}}" value="{{$data->下月開線數}}"
                                        step="0.0000001" min="0"></td>
                                <td><input style="width:100px" class="form-control form-control-lg" type="number"
                                        id="dataq{{$loop->index}}" name="dataq{{$loop->index}}" value="{{$data->下月開班數}}"
                                        step="0.0000001" min="0"></td>
                                <td><input style="width:100px" class="form-control form-control-lg" type="number"
                                        id="datar{{$loop->index}}" name="datar{{$loop->index}}"
                                        value="{{$data->下月每人每日需求量}}" step="0.0000001" min="0">
                                </td>
                                <td><input style="width:100px" class="form-control form-control-lg" type="number"
                                        id="datas{{$loop->index}}" name="datas{{$loop->index}}"
                                        value="{{$data->下月每日更換頻率}}" step="0.0000001" min="0">
                                </td>
                                <td><input style="width:120px" class="form-control form-control-lg" type="number"
