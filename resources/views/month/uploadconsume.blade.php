            ...
            <div class="card">
                ...
                <div class="card w-100">
                    ...
                    <form id="uploadconsume" method="POST">
                            ...
                            <table class="table">
                                ...
                                ?>
                                    ...
                                    <td><input style="width:200px" type="number" id="datac{{$loop->index}}"
                                            ...
                                            value="{{$row[4]}}" class="form-control form-control-lg" min="0.0000000001">
                                    </td>
                        ...
                        <input type="text" class="form-control form-control" id="jobnumber" name="jobnumber" required
                            placeholder="{!! __('monthlyPRpageLang.nopeople') !!}" style="width: 250px"> --}}
                        <div class="w-100" style="height: 1ch;"></div><!-- </div>breaks cols to a new line-->
