...
return [
    ...
    */
    ...
    'stock' => '库存',
    'monthuse' => '月使用量',
    'qty_exceed' => '调拨数量不可大于现有库存',
    'qty_empty' => '调拨数量不可为0',
    'newloc_empty' => '未选择送至储位',
    'newloc_same' => '送至储位与原储位相同',
    'altered_by_other_recently' => '已被他人修改，请重新查询',
    'coming' => '即将从',
    'transfer' => '调拨',
    'to' => '到',
    'other' => '其他',
    ...
    'rfidinpeople' => '请点这里感应人员识别证',
    'no_basic' => '料号资料不存在',
    'no_basic_are_highlighted' => '红字料号表示其料件讯息未维护',
    'stock_within_brackets' => '(括号)内为调拨前库存量',
    'within_a_month' => '一个月内',
