...
return [
    ...
    */
    ...
    'data' => 'data',
    'nosendpeople' => 'The job number of the sender does not exist, please go to User Management-Maintenance -> Person Information',
    'nopickpeople' => 'The job number of the picker does not exist, please go to User Management-Maintenance -> Person Information',
    'nobackpeople' => 'The job number of the return people does not exist, please go to User Management-Maintenance -> Person Information',
    'noreceivepeople' => 'The job number of the Receiver does not exist, please go to User Management-Maintenance -> Person Information',
    ...
    'noinpeople' => 'The job number of the inbound people does not exist, please go to User Management-Maintenance -> Person Information',
